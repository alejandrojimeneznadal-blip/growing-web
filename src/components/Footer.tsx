...
export default function Footer() {
  return (
    <footer className="bg-[#101820] py-16">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        {/* Top section */}
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-12 pb-12 border-b border-white/10">
          {/* Left - Brand */}
          ...
          <div className="flex flex-wrap gap-12 lg:gap-16">
            <div>
              <h4 className="text-xs font-medium tracking-wider text-gray-500 mb-4">
                EMPRESA
              </h4>
